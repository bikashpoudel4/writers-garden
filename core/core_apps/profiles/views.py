...
class UpdateProfileAPIView(generics.RetrieveAPIView):
    ...
    permission_classes = [IsAuthenticated]
    parser_classes = [MultiPartParser] # MultiPartParser = to handle fileupload for profile photo
    renderer_classes = [ProfileJSONRenderer]
...
class FollowingListView(APIView):
    def get(self, request, user_id, format=None):
        try:
            ...
            following_profiles = profile.following.all() # following comes from model's related name
